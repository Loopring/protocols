...
library OrderHelper {
        ...
        pure
    {
        ...
        assembly {
            ...
            mstore(add(ptr, sub(348, 31)), mload(add(order, 576)))   // allOrNone
            mstore(add(ptr, sub(346, 30)), mload(add(order, 768)))   // tokenBFeePercentage
            mstore(add(ptr, sub(344, 30)), mload(add(order, 736)))   // tokenSFeePercentage
            mstore(add(ptr, sub(342, 30)), mload(add(order, 672)))   // feePercentage
            mstore(add(ptr, sub(340, 30)), mload(add(order, 832)))   // walletSplitPercentage
            mstore(add(ptr, sub(320, 12)), mload(add(order, 608)))   // feeToken
            mstore(add(ptr, sub(300, 12)), mload(add(order, 800)))   // tokenRecipient
            mstore(add(ptr, sub(280, 12)), mload(add(order, 448)))   // wallet
            mstore(add(ptr, sub(260, 12)), mload(add(order, 416)))   // orderInterceptor
            mstore(add(ptr, sub(240, 12)), mload(add(order, 320)))   // broker
            mstore(add(ptr, sub(220, 12)), mload(add(order, 288)))   // dualAuthAddr
            mstore(add(ptr, sub(200, 12)), mload(add(order,  96)))   // tokenB
            mstore(add(ptr, sub(180, 12)), mload(add(order,  64)))   // tokenS
            mstore(add(ptr, sub(160, 12)), mload(add(order,  32)))   // owner
            mstore(add(ptr, sub(128,  0)), mload(add(order, 480)))   // validUntil
            mstore(add(ptr, sub( 96,  0)), mload(add(order, 192)))   // validSince
            mstore(add(ptr, sub( 64,  0)), mload(add(order, 640)))   // feeAmount
            mstore(add(ptr, sub( 32,  0)), mload(add(order, 160)))   // amountB
            mstore(add(ptr, sub(  0,  0)), mload(add(order, 128)))   // amountS
