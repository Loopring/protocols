...
class State(object):
    ...
    def executeTransaction(self, context, txInput):
        ...
        if txInput.txType == "Noop":
            ...
            newState.TXV_BALANCE_A_S_WEIGHT = int(accountA.getBalanceLeaf(newState.TXV_BALANCE_A_S_ADDRESS).weightAMM) - fillA.S if ring.orderA.amm else None

            newState.TXV_BALANCE_A_B_ADDRESS = ring.orderA.tokenB
            newState.TXV_BALANCE_A_B_BALANCE = fillA.B - fee_BA
            newState.TXV_BALANCE_A_B_WEIGHT = int(accountA.getBalanceLeaf(newState.TXV_BALANCE_A_B_ADDRESS).weightAMM) + fillA.B if ring.orderA.amm else None
            ...
            newState.TXV_BALANCE_B_S_WEIGHT = int(accountB.getBalanceLeaf(newState.TXV_BALANCE_B_S_ADDRESS).weightAMM) - fillB.S if ring.orderB.amm else None

            newState.TXV_BALANCE_B_B_ADDRESS = ring.orderB.tokenB
            newState.TXV_BALANCE_B_B_BALANCE = fillB.B - fee_BB
            newState.TXV_BALANCE_B_B_WEIGHT = int(accountB.getBalanceLeaf(newState.TXV_BALANCE_B_B_ADDRESS).weightAMM) + fillB.B if ring.orderB.amm else None
            ...
            accountA = self.getAccount(newState.TXV_ACCOUNT_A_ADDRESS)
            newState.TXV_BALANCE_A_S_WEIGHT = int(txInput.tokenWeight)
