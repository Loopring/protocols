...
library ExchangeDeposits {
    ...
    function deposit(
        ...
        bool isFlashDeposit // inline call
    ) internal {
        ...
        if (isFlashDeposit) {
            ...
            S.flashDepositAmounts[tokenAddress] = S
                .flashDepositAmounts[tokenAddress]
                .add(amount);
        } else {
            ...
            emit DepositRequested(from, to, tokenAddress, tokenID, _amount);
        }
