...
contract Errors
{
    ...
    string constant CANNOT_DEPOSIT_TO_DUAL_AUTHOR_ACCOUNTS  = "CANNOT_DEPOSIT_TO_DUAL_AUTHOR_ACCOUNTS";
    string constant UNAUTHORIZED_FOR_DUAL_AUTHOR_ACCOUNT    = "UNAUTHORIZED_FOR_DUAL_AUTHOR_ACCOUNT";
