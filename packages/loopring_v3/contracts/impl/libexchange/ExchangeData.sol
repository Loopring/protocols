...
library ExchangeData
{
    ...
    function MAX_OPEN_DEPOSIT_REQUESTS() internal pure returns (uint16) { return 2048; }
    function MAX_OPEN_WITHDRAWAL_REQUESTS() internal pure returns (uint16) { return 2048; }
