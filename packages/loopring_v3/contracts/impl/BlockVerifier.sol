...
contract BlockVerifier is ReentrancyGuard, IBlockVerifier
{
    ...
    function registerCircuit(
        ...
        onlyOwner
    {
        Circuit storage circuit = circuits[isRollup][blockType][blockSize][blockVersion];
    ...
    function isCircuitRegistered(
        ...
        returns (bool)
    {
        return circuits[isRollup][blockType][blockSize][blockVersion].registered;
    }
    ...
    function isCircuitEnabled(
        ...
        returns (bool)
    {
        return circuits[isRollup][blockType][blockSize][blockVersion].enabled;
    }
}
