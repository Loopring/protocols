...
library TransactionReader {
    ...
    function readTxs(
        ...
        require(
            txIdx + numTransactions <= _block.blockSize,
            "INVALID_TX_RANGE"
        );

        uint TX_DATA_AVAILABILITY_SIZE = ExchangeData.TX_DATA_AVAILABILITY_SIZE;
        uint TX_DATA_AVAILABILITY_SIZE_PART_1 = ExchangeData
            .TX_DATA_AVAILABILITY_SIZE_PART_1;
        uint TX_DATA_AVAILABILITY_SIZE_PART_2 = ExchangeData
            .TX_DATA_AVAILABILITY_SIZE_PART_2;
