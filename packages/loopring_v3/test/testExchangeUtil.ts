...
export class ExchangeTestUtil {
  ...
  public async initialize(accounts: string[]) {
    ...
    // Register LoopringV3 to GlobalRegistry
    // await this.globalRegistry.registerProtocol(
    //   this.loopringV3.address,
    //   this.exchange.address,
    //   { from: this.testContext.deployer }
    // );
    await this.globalRegistry.setDefaultProtocol(this.loopringV3.address, {
      from: this.testContext.deployer
    });
  ...
  public async createExchange(
    ...
    await LRC.approve(this.globalRegistry.address, exchangeCreationCostLRC, {
      from: owner
    });
    ...
    const tx = await this.globalRegistry.forgeExchange(
      this.loopringV3.address,
  ...
  private async createContractContext() {
    const [
      ...
      this.contracts.GlobalRegistry.deployed(),
