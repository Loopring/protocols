...
export class ExchangeTestUtil {
  ...
  public async registerCircuit(
    ...
    block.rollupEnabled = this.rollupEnabled;
    fs.writeFileSync(
      blockFilename,
    ...
    if (!isCircuitRegistered) {
      ...
      verificationKeyFilename += block.rollupEnabled ? "_DA_" : "_";
  ...
  public async submitTransactions(forcedBlockSize?: number) {
    ...
    while (numTransactionsDone < pendingTransactions.length) {
      ...
      const txBlock: TxBlock = {
        transactions,
        rollupEnabled: this.rollupEnabled,
        timestamp,
  ...
  public async createExchange(
    ...
    const stakeAmount = rollupEnabled
