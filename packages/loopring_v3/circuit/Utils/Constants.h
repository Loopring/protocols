...
static const unsigned int NUM_BITS_BIPS = 14; // ceil(log2(100*100))
...
static const unsigned int NUM_BITS_NFT_ID = 256;
static const unsigned int NFT_TOKEN_ID_START = 32768; // 2**(NUM_BITS_TOKEN - 1)
