...
static void
print(const ProtoboardT &pb, const char *description, const ethsnarks::VariableT &variable)
{
...
subArray(const VariableArrayT &bits, unsigned int start, unsigned int length)
{
  VariableArrayT result;
