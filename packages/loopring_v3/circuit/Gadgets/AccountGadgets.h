    ...
    UpdateAccountGadget(
      ...
      const std::string &prefix)
        : GadgetT(pb, prefix),
          ...
          rootAfter(pb, TREE_DEPTH_ACCOUNTS, slotID, leafAfter.result(), proof, FMT(prefix, ".pathAfter"))
    {
    }
      ...
      const std::string &prefix)
        : GadgetT(pb, prefix),
          ...
          rootBeforeVerifier(
            ...
            proof,
            FMT(prefix, ".pathBefore")),
          rootAfter(pb, TREE_DEPTH_TOKENS, tokenID, leafAfter.result(), proof, FMT(prefix, ".pathAfter"))
    {
    }
