...
public:
    ...
    UpdateStorageGadget(
        ...
        proofVerifierBefore(pb, TREE_DEPTH_STORAGE, address, leafBefore.result(), merkleRoot, proof, FMT(prefix, ".pathBefore")),
        rootCalculatorAfter(pb, TREE_DEPTH_STORAGE, address, leafAfter.result(), proof, FMT(prefix, ".pathAfter"))
    {
...
public:
    ...
    StorageReaderGadget(
        ...
        isNonZeroStorageLeadStorageID(pb, storage.storageID, FMT(prefix, ".isNonZeroStorageLeadStorageID")),
        leafStorageID(pb, isNonZeroStorageLeadStorageID.result(), storage.storageID, address, FMT(prefix, ".leafStorageID")),
...
public:
    ...
    {
        return reverse(flattenReverse({VariableArrayT(1, constants._0), VariableArrayT(1, storageReader.getOverwrite()),
