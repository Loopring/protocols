...
// require(A == B)
static void requireEqual(ProtoboardT &_pb, const VariableT &A,
                         const VariableT &B,
...
public:
  ...
  Constants(ProtoboardT &_pb, const std::string &prefix)
      : GadgetT(_pb, prefix),

        _0(make_variable(_pb, FieldT::zero(), FMT(prefix, ".zero"))),
        _1(make_variable(_pb, FieldT::one(), FMT(prefix, ".one"))),
        _2(make_variable(_pb, ethsnarks::FieldT(2), FMT(prefix, ".two"))),
        _3(make_variable(_pb, ethsnarks::FieldT(3), FMT(prefix, ".three"))),
        _4(make_variable(_pb, ethsnarks::FieldT(4), FMT(prefix, ".four"))),
        _5(make_variable(_pb, ethsnarks::FieldT(5), FMT(prefix, ".five"))),
        _6(make_variable(_pb, ethsnarks::FieldT(6), FMT(prefix, ".six"))),
        _7(make_variable(_pb, ethsnarks::FieldT(7), FMT(prefix, ".seven"))),
        _8(make_variable(_pb, ethsnarks::FieldT(8), FMT(prefix, ".eight"))),
        _9(make_variable(_pb, ethsnarks::FieldT(9), FMT(prefix, ".nine"))),
        _10(make_variable(_pb, ethsnarks::FieldT(10), FMT(prefix, ".ten"))),
        _1000(
            make_variable(_pb, ethsnarks::FieldT(1000), FMT(prefix, "._1000"))),
        _1001(
            make_variable(_pb, ethsnarks::FieldT(1001), FMT(prefix, "._1001"))),
        _10000(make_variable(_pb, ethsnarks::FieldT(10000),
                             FMT(prefix, "._10000"))),
        _100000(make_variable(_pb, ethsnarks::FieldT(100000),
                              FMT(prefix, "._100000"))),
        emptyStorage(make_variable(_pb, ethsnarks::FieldT(EMPTY_TRADE_HISTORY),
                                   FMT(prefix, ".emptyStorage"))),
        maxAmount(make_variable(_pb, ethsnarks::FieldT(MAX_AMOUNT),
                                FMT(prefix, ".maxAmount"))),
        numStorageSlots(make_variable(_pb, ethsnarks::FieldT(NUM_STORAGE_SLOTS),
                                      FMT(prefix, ".numStorageSlots"))),
        ...
        txTypeSpotTrade(make_variable(
            pb, ethsnarks::FieldT(int(TransactionType::SpotTrade)),
            FMT(prefix, ".txTypeSpotTrade"))),
        txTypeTransfer(make_variable(
            _pb, ethsnarks::FieldT(int(TransactionType::Transfer)),
  ...
  void generate_r1cs_constraints() {
    pb.add_r1cs_constraint(ConstraintT(_0, FieldT::one(), FieldT::zero()),
                           ".zero");
    pb.add_r1cs_constraint(ConstraintT(_1, FieldT::one(), FieldT::one()),
                           ".one");
    ...
    pb.add_r1cs_constraint(
        ConstraintT(_1000, FieldT::one(), ethsnarks::FieldT(1000)), "._1000");
    pb.add_r1cs_constraint(
        ConstraintT(_1001, FieldT::one(), ethsnarks::FieldT(1001)), "._1001");
    pb.add_r1cs_constraint(
        ConstraintT(_10000, FieldT::one(), ethsnarks::FieldT(10000)),
        "._10000");
    pb.add_r1cs_constraint(
        ConstraintT(_100000, FieldT::one(), ethsnarks::FieldT(100000)),
        "._100000");
    pb.add_r1cs_constraint(ConstraintT(emptyStorage, FieldT::one(),
                                       ethsnarks::FieldT(EMPTY_TRADE_HISTORY)),
                           ".emptyStorage");
    pb.add_r1cs_constraint(
        ConstraintT(maxAmount, FieldT::one(), ethsnarks::FieldT(MAX_AMOUNT)),
        ".maxAmount");
    pb.add_r1cs_constraint(ConstraintT(numStorageSlots, FieldT::one(),
                                       ethsnarks::FieldT(NUM_STORAGE_SLOTS)),
                           ".numStorageSlots");
    pb.add_r1cs_constraint(
        ConstraintT(dummyPublicKeyX, FieldT::one(),
                    ethsnarks::FieldT("1324049161674411857737169376390989500302"
                                      "14269269071041759116060313694190797")),
        ".dummyPublicKeyX");
    pb.add_r1cs_constraint(
        ConstraintT(dummyPublicKeyY, FieldT::one(),
                    ethsnarks::FieldT("6933274320914065805670637410453081675154"
                                      "127044926882796951068647148079547843")),
        ".dummyPublicKeyY");
    pb.add_r1cs_constraint(
        ConstraintT(txTypeSpotTrade, FieldT::one(),
                    ethsnarks::FieldT(int(TransactionType::SpotTrade))),
        ".txTypeSpotTrade");
    pb.add_r1cs_constraint(
        ConstraintT(txTypeTransfer, FieldT::one(),
...
public:
  ...
  DualVariableGadget(ProtoboardT &_pb, const size_t width,
                     const std::string &prefix)
      : libsnark::dual_variable_gadget<FieldT>(_pb, width, prefix) {}

  DualVariableGadget(ProtoboardT &_pb, const VariableT &value,
                     const size_t width, const std::string &prefix)
      : libsnark::dual_variable_gadget<FieldT>(_pb, value, width, prefix) {
    fromPacked = true;
  }

  DualVariableGadget(ProtoboardT &_pb, const VariableArrayT &bits,
                     const std::string &prefix)
      : libsnark::dual_variable_gadget<FieldT>(_pb, bits, prefix) {
    fromBits = true;
  }
  ...
  void generate_r1cs_witness(ProtoboardT &_pb, const FieldT &value) {
    assert(!fromPacked && !fromBits);
    pb.val(packed) = value;
    generate_r1cs_witness_from_packed();
  }

  void generate_r1cs_witness(ProtoboardT &_pb, const LimbT &value) {
    assert(!fromPacked && !fromBits);
...
public:
  ...
  DynamicVariableGadget(ProtoboardT &_pb, const std::string &prefix)
      : GadgetT(_pb, prefix) {
    add(make_variable(_pb, FMT(prefix, ".initialValue")));
    allowGeneratingWitness = true;
  }

  DynamicVariableGadget(ProtoboardT &_pb, const VariableT &initialValue,
                        const std::string &prefix)
      : GadgetT(_pb, prefix) {
    add(initialValue);
...
public:
  ...
  UnsafeSubGadget(ProtoboardT &_pb, const VariableT &_value,
                  const VariableT &_sub, const std::string &prefix)
      : GadgetT(_pb, prefix), value(_value), sub(_sub),
        sum(make_variable(_pb, FMT(prefix, ".sum"))) {}
...
public:
  ...
  UnsafeAddGadget(ProtoboardT &_pb, const VariableT &_value,
                  const VariableT &_add, const std::string &prefix)
      : GadgetT(_pb, prefix), value(_value), add(_add),
        sum(make_variable(_pb, FMT(prefix, ".sum"))) {}
  ...
  void generate_r1cs_constraints() {
    pb.add_r1cs_constraint(ConstraintT(value + add, FieldT::one(), sum),
...
public:
  ...
  UnsafeMulGadget(ProtoboardT &_pb, const VariableT &_valueA,
                  const VariableT &_valueB, const std::string &prefix)
      : GadgetT(_pb, prefix), valueA(_valueA), valueB(_valueB),
        product(make_variable(_pb, FMT(prefix, ".product"))) {}
  ...
  void generate_r1cs_constraints() {
    pb.add_r1cs_constraint(ConstraintT(valueA, valueB, product),
...
public:
  ...
  AddGadget(ProtoboardT &_pb, const VariableT &A, const VariableT &B,
            unsigned int n, const std::string &prefix)
      : GadgetT(_pb, prefix),

        unsafeAdd(_pb, A, B, FMT(prefix, ".unsafeAdd")),
        rangeCheck(_pb, unsafeAdd.result(), n, FMT(prefix, ".rangeCheck")) {
...
public:
  ...
  SubGadget(ProtoboardT &_pb, const VariableT &A, const VariableT &B,
            unsigned int n, const std::string &prefix)
      : GadgetT(_pb, prefix),

        unsafeSub(_pb, A, B, FMT(prefix, ".unsafeAdd")),
        rangeCheck(_pb, unsafeSub.result(), n, FMT(prefix, ".rangeCheck")) {
    assert(n + 1 <= NUM_BITS_FIELD_CAPACITY);
  }
...
public:
  ...
  TransferGadget(ProtoboardT &_pb, DynamicVariableGadget &from,
                 DynamicVariableGadget &to, const VariableT &value,
                 const std::string &prefix)
      : GadgetT(_pb, prefix),

        sub(_pb, from.back(), value, NUM_BITS_AMOUNT, FMT(prefix, ".sub")),
        add(_pb, to.back(), value, NUM_BITS_AMOUNT, FMT(prefix, ".add")) {
...
public:
  ...
  TernaryGadget(ProtoboardT &_pb, const VariableT &_b, const VariableT &_x,
                const VariableT &_y, const std::string &prefix)
      : GadgetT(_pb, prefix),

        b(_b), x(_x), y(_y),

        selected(make_variable(_pb, FMT(prefix, ".selected"))) {}
...
public:
  ...
  ArrayTernaryGadget(ProtoboardT &_pb, const VariableT &_b,
                     const VariableArrayT &x, const VariableArrayT &y,
                     const std::string &prefix)
      : GadgetT(_pb, prefix), b(_b) {
    assert(x.size() == y.size());
    results.reserve(x.size());
    for (unsigned int i = 0; i < x.size(); i++) {
      results.emplace_back(
          TernaryGadget(_pb, b, x[i], y[i], FMT(prefix, ".results")));
...
public:
  ...
  AndGadget(ProtoboardT &_pb, const std::vector<VariableT> &_inputs,
            const std::string &prefix)
      : GadgetT(_pb, prefix), inputs(_inputs) {
    assert(inputs.size() > 1);
    for (unsigned int i = 1; i < inputs.size(); i++) {
      results.emplace_back(make_variable(_pb, FMT(prefix, ".results")));
    }
  }
...
public:
  ...
  OrGadget(ProtoboardT &_pb, const std::vector<VariableT> &_inputs,
           const std::string &prefix)
      : GadgetT(_pb, prefix), inputs(_inputs) {
    assert(inputs.size() > 1);
    for (unsigned int i = 1; i < inputs.size(); i++) {
  ...
  void generate_r1cs_witness() {
    pb.val(results[0]) =
        FieldT::one() - (FieldT::one() - pb.val(inputs[0])) *
                            (FieldT::one() - pb.val(inputs[1]));
    for (unsigned int i = 2; i < inputs.size(); i++) {
      pb.val(results[i - 1]) =
          FieldT::one() - (FieldT::one() - pb.val(results[i - 2])) *
  ...
  void generate_r1cs_constraints() {
    ...
    for (unsigned int i = 2; i < inputs.size(); i++) {
      pb.add_r1cs_constraint(ConstraintT(FieldT::one() - inputs[i],
...
public:
  ...
  NotGadget(ProtoboardT &_pb, const VariableT &_A, const std::string &prefix)
      : GadgetT(_pb, prefix),

        A(_A), _not(make_variable(_pb, FMT(prefix, "._not"))) {}
...
public:
  ...
  XorArrayGadget(ProtoboardT &_pb, VariableArrayT _A, VariableArrayT _B,
                 const std::string &prefix)
      : GadgetT(_pb, prefix),

        A(_A), B(_B),

        C(make_var_array(_pb, A.size(), FMT(prefix, ".C"))) {
  ...
  void generate_r1cs_witness() {
    for (unsigned int i = 0; i < C.size(); i++) {
      pb.val(C[i]) =
          pb.val(A[i]) + pb.val(B[i]) -
          ((pb.val(A[i]) == FieldT::one() && pb.val(B[i]) == FieldT::one())
               ? 2
               : 0);
    }
  }
  ...
  void generate_r1cs_constraints() {
    for (unsigned int i = 0; i < C.size(); i++) {
      pb.add_r1cs_constraint(ConstraintT(2 * A[i], B[i], A[i] + B[i] - C[i]),
                             FMT(annotation_prefix, ".A ^ B == C"));
    }
  }
};
...
public:
  ...
  EqualGadget(ProtoboardT &_pb, const VariableT &A, const VariableT &B,
              const std::string &prefix)
      : GadgetT(_pb, prefix),

        difference(_pb, A, B, FMT(prefix, ".difference")),
        isNonZeroDifference(_pb, difference.result(),
                            FMT(prefix, ".isNonZeroDifference")),
        isZeroDifference(_pb, isNonZeroDifference.result(),
                         FMT(prefix, ".isZeroDifference")) {}
...
public:
  ...
  RequireEqualGadget(ProtoboardT &_pb, const VariableT &_A, const VariableT &_B,
                     const std::string &prefix)
      : GadgetT(_pb, prefix), A(_A), B(_B) {}

  void generate_r1cs_witness() {}

  void generate_r1cs_constraints() {
    requireEqual(_pb, A, B, FMT(annotation_prefix, ".requireEqual"));
  }
};
...
public:
  ...
  RequireZeroAorBGadget(ProtoboardT &_pb, const VariableT &_A,
                        const VariableT &_B, const std::string &prefix)
      : GadgetT(_pb, prefix), A(_A), B(_B) {}

  void generate_r1cs_witness() {}

  void generate_r1cs_constraints() {
    pb.add_r1cs_constraint(ConstraintT(A, B, FieldT::zero()),
                           FMT(annotation_prefix, ".A == 0 || B == 0"));
  }
};
...
public:
  ...
  RequireNotZeroGadget(ProtoboardT &_pb, const VariableT &_A,
                       const std::string &prefix)
      : GadgetT(_pb, prefix), A(_A),
        A_inv(make_variable(_pb, FMT(prefix, ".A_inv"))) {}

  void generate_r1cs_witness() { pb.val(A_inv) = pb.val(A).inverse(); }

  void generate_r1cs_constraints() {
    pb.add_r1cs_constraint(ConstraintT(A, A_inv, FieldT::one()),
                           FMT(annotation_prefix, ".A * A_inv == 1"));
  }
};
...
public:
  ...
  RequireNotEqualGadget(ProtoboardT &_pb, const VariableT &_A,
                        const VariableT &_B, const std::string &prefix)
      : GadgetT(_pb, prefix), A(_A), B(_B),
        difference(make_variable(_pb, FMT(prefix, ".difference"))),
        notZero(_pb, difference, FMT(prefix, ".difference != 0")) {}
  ...
  void generate_r1cs_constraints() {
    pb.add_r1cs_constraint(ConstraintT(A - B, FieldT::one(), difference),
...
public:
  ...
  LeqGadget(ProtoboardT &_pb, const VariableT &A, const VariableT &B,
            const size_t n, const std::string &prefix)
      : GadgetT(_pb, prefix),

        _lt(make_variable(_pb, 1, FMT(prefix, ".lt"))),
        _leq(make_variable(_pb, 1, FMT(prefix, ".leq"))),
        comparison(_pb, n, A, B, _lt, _leq, FMT(prefix, ".A <(=) B")),
        _gt(_pb, _leq, FMT(prefix, ".gt")), _gte(_pb, _lt, FMT(prefix, ".gte")),
        _eq(_pb, {_leq, _gte.result()}, FMT(prefix, ".eq")) {
...
public:
  ...
  LtFieldGadget(ProtoboardT &_pb, const VariableT &A, const VariableT &B,
                const std::string &prefix)
      : GadgetT(_pb, prefix),

        Abits(_pb, A, FMT(prefix, ".Abits")),
        Bbits(_pb, B, FMT(prefix, ".Bbits")),

        Alo(_pb, subArray(Abits.result(), 0, 254 / 2), FMT(prefix, ".Alo")),
        Ahi(_pb, subArray(Abits.result(), 254 / 2, 254 / 2),
            FMT(prefix, ".Ahi")),
        Blo(_pb, subArray(Bbits.result(), 0, 254 / 2), FMT(prefix, ".Blo")),
        Bhi(_pb, subArray(Bbits.result(), 254 / 2, 254 / 2),
            FMT(prefix, ".Bhi")),
        partLo(_pb, Alo.packed, Blo.packed, 254 / 2, FMT(prefix, ".partLo")),
        partHi(_pb, Ahi.packed, Bhi.packed, 254 / 2, FMT(prefix, ".partHi")),
        res(_pb, partHi.eq(), partLo.lt(), partHi.lt(), FMT(prefix, ".res")) {}
...
public:
  ...
  MinGadget(ProtoboardT &_pb, const VariableT &A, const VariableT &B,
            const size_t n, const std::string &prefix)
      : GadgetT(_pb, prefix),

        A_lt_B(_pb, A, B, n, FMT(prefix, ".(A < B)")),
        minimum(_pb, A_lt_B.lt(), A, B,
                FMT(prefix, ".minimum = (A < B) ? A : B")) {}
...
public:
  ...
  MaxGadget(ProtoboardT &_pb, const VariableT &A, const VariableT &B,
            const size_t n, const std::string &prefix)
      : GadgetT(_pb, prefix),

        A_lt_B(_pb, A, B, n, FMT(prefix, ".(A < B)")),
        maximum(_pb, A_lt_B.lt(), B, A,
                FMT(prefix, ".maximum = (A < B) ? B : A")) {}
...
public:
  ...
  RequireLeqGadget(ProtoboardT &_pb, const VariableT &A, const VariableT &B,
                   const size_t n, const std::string &prefix)
      : GadgetT(_pb, prefix),

        leqGadget(_pb, A, B, n, FMT(prefix, ".leq")) {}
...
public:
  ...
  RequireLtGadget(ProtoboardT &_pb, const VariableT &A, const VariableT &B,
                  const size_t n, const std::string &prefix)
      : GadgetT(_pb, prefix),
...
public:
  ...
  IfThenRequireGadget(ProtoboardT &_pb, const VariableT &C, const VariableT &A,
                      const std::string &prefix)
      : GadgetT(_pb, prefix),

        notC(_pb, C, FMT(prefix, ".notC")),
        res(_pb, {notC.result(), A}, FMT(prefix, ".res")) {}
  ...
  void generate_r1cs_constraints() {
    ...
    res.generate_r1cs_constraints();
    pb.add_r1cs_constraint(
        ConstraintT(res.result(), FieldT::one(), FieldT::one()),
        FMT(annotation_prefix, ".valid"));
  }
};
...
public:
  ...
  IfThenRequireEqualGadget(ProtoboardT &_pb, const VariableT &C,
                           const VariableT &A, const VariableT &B,
                           const std::string &prefix)
      : GadgetT(_pb, prefix),

        eq(_pb, A, B, FMT(prefix, ".eq")),
        res(_pb, C, eq.result(), FMT(prefix, ".res")) {}
...
public:
  ...
  IfThenRequireNotEqualGadget(ProtoboardT &_pb, const VariableT &C,
                              const VariableT &A, const VariableT &B,
                              const std::string &prefix)
      : GadgetT(_pb, prefix),

        eq(_pb, A, B, FMT(prefix, ".eq")),
        notEq(_pb, eq.result(), FMT(prefix, ".notEq")),
        res(_pb, C, notEq.result(), FMT(prefix, ".res")) {}
...
public:
  ...
  MulDivGadget(ProtoboardT &_pb, const Constants &constants,
               const VariableT &_value, const VariableT &_numerator,
               const VariableT &_denominator, unsigned int numBitsValue,
               unsigned int numBitsNumerator, unsigned int numBitsDenominator,
               const std::string &prefix)
      : GadgetT(_pb, prefix),

        value(_value), numerator(_numerator), denominator(_denominator),

        quotient(make_variable(_pb, FMT(prefix, ".quotient"))),

        denominator_notZero(_pb, denominator,
                            FMT(prefix, ".denominator_notZero")),
        product(_pb, value, numerator, FMT(prefix, ".product")),
        // Range limit the remainder. The comparison below is not guaranteed to
        // work for very large values.
        remainder(_pb, numBitsDenominator, FMT(prefix, ".remainder")),
        remainder_lt_denominator(_pb, remainder.packed, denominator,
                                 numBitsDenominator,
  ...
  void generate_r1cs_witness() {
    ...
    if (pb.val(denominator) != FieldT::zero()) {
      pb.val(quotient) = ethsnarks::FieldT(
          (toBigInt(pb.val(product.result())) / toBigInt(pb.val(denominator)))
              .to_string()
              .c_str());
    } else {
      pb.val(quotient) = FieldT::zero();
    }
    pb.val(remainder.packed) =
        pb.val(product.result()) - (pb.val(denominator) * pb.val(quotient));
  ...
  void generate_r1cs_constraints() {
    ...
    pb.add_r1cs_constraint(
        ...
        FMT(annotation_prefix,
            ".quotient * denominator == product - remainder"));
...
public:
  ...
  RequireAccuracyGadget(ProtoboardT &_pb, const VariableT &_value,
                        const VariableT &_original, const Accuracy &_accuracy,
                        unsigned int maxNumBits, const std::string &prefix)
      : GadgetT(_pb, prefix),

        // Range limit the value. The comparison below is not guaranteed to work
        // for very large values.
        value(_pb, _value, maxNumBits, FMT(prefix, ".value")),
        original(_original), accuracy(_accuracy),

        value_leq_original(_pb, value.packed, original, maxNumBits,
                           FMT(prefix, ".value_lt_original")),

        original_mul_accuracyN(
            make_variable(_pb, FMT(prefix, ".original_mul_accuracyN"))),
        value_mul_accuracyD(
            make_variable(_pb, FMT(prefix, ".value_mul_accuracyD"))),

        original_mul_accuracyN_LEQ_value_mul_accuracyD(
            pb, original_mul_accuracyN, value_mul_accuracyD, maxNumBits + 32,
  ...
  void generate_r1cs_constraints() {
    ...
    pb.add_r1cs_constraint(
        ...
        FMT(annotation_prefix,
            ".original * accuracy.numerator == original_mul_accuracyN"));
    pb.add_r1cs_constraint(
        ConstraintT(value.packed, accuracy.denominator, value_mul_accuracyD),
        FMT(annotation_prefix,
            ".value * accuracy.denominator == value_mul_accuracyD"));
...
public:
  ...
  PublicDataGadget(ProtoboardT &_pb, const std::string &prefix)
      : GadgetT(_pb, prefix),
        publicInput(make_variable(_pb, FMT(prefix, ".publicInput"))) {
  ...
  void generate_r1cs_witness() {
    ...
    print(_pb, "[ZKS]publicInput", calculatedHash->packed);
  }

  void generate_r1cs_constraints() {
    // Calculate the hash
    hasher.reset(new sha256_many(_pb, publicDataBits, ".hasher"));
    ...
    requireEqual(_pb, calculatedHash->packed, publicInput, ".publicDataCheck");
  }
};
...
public:
  ...
  FloatGadget(ProtoboardT &_pb, const Constants &_constants,
              const FloatEncoding &_floatEncoding, const std::string &prefix)
      : GadgetT(_pb, prefix),
    ...
    for (unsigned int i = 0; i < f.size(); i++) {
      values.emplace_back(
          make_variable(_pb, FMT(prefix, ".FloatToUintGadgetVariable")));
    }

    for (unsigned int i = 0; i < floatEncoding.numBitsExponent; i++) {
      baseMultipliers.emplace_back(
          make_variable(_pb, FMT(prefix, ".baseMultipliers")));
      multipliers.emplace_back(TernaryGadget(
          pb, f[floatEncoding.numBitsMantissa + i], baseMultipliers[i],
          constants._1, FMT(prefix, ".multipliers")));
    }
  }

  void generate_r1cs_witness(const ethsnarks::FieldT &floatValue) {
    f.fill_with_bits_of_field_element(_pb, floatValue);

    // Decodes the mantissa
    for (unsigned int i = 0; i < floatEncoding.numBitsMantissa; i++) {
      unsigned j = floatEncoding.numBitsMantissa - 1 - i;
      pb.val(values[i]) =
          (i == 0) ? pb.val(f[j]) : (pb.val(values[i - 1]) * 2 + pb.val(f[j]));
    }
    ...
    for (unsigned int i = floatEncoding.numBitsMantissa; i < f.size(); i++) {
      ...
      pb.val(values[i]) =
          pb.val(values[i - 1]) * pb.val(multipliers[j].result());
    }
  }
  ...
  void generate_r1cs_constraints() {
    ...
    for (unsigned int i = 0; i < floatEncoding.numBitsMantissa; i++) {
      ...
      if (i == 0) {
        pb.add_r1cs_constraint(
            ...
            FMT(annotation_prefix,
                (std::string(".value_") + std::to_string(i)).c_str()));
      } else {
        pb.add_r1cs_constraint(
    ...
    for (unsigned int i = floatEncoding.numBitsMantissa; i < f.size(); i++) {
      ...
      unsigned int j = i - floatEncoding.numBitsMantissa;
      if (j == 0) {
        pb.add_r1cs_constraint(ConstraintT(floatEncoding.exponentBase,
                                           FieldT::one(), baseMultipliers[j]),
                               ".baseMultipliers");
      } else {
        pb.add_r1cs_constraint(ConstraintT(baseMultipliers[j - 1],
                                           baseMultipliers[j - 1],
                                           baseMultipliers[j]),
                               ".baseMultipliers");
      }
      ...
      // Shift the value with the partial exponent
      pb.add_r1cs_constraint(
          ConstraintT(values[i - 1], multipliers[j].result(), values[i]),
          ".valuesExp");
    }
  }
...
struct SelectorGadget : public GadgetT {
  ...
  SelectorGadget(ProtoboardT &_pb, const Constants &_constants,
                 const VariableT &type, unsigned int maxBits,
                 const std::string &prefix)
      : GadgetT(_pb, prefix), constants(_constants) {
    assert(maxBits <= constants.values.size());
    for (unsigned int i = 0; i < maxBits; i++) {
      bits.emplace_back(_pb, type, constants.values[i],
                        FMT(annotation_prefix, ".bits"));
      sum.emplace_back(_pb, (i == 0) ? constants._0 : sum.back().result(),
                       bits.back().result(), FMT(annotation_prefix, ".sum"));
  ...
  void generate_r1cs_constraints() {
    ...
    requireEqual(_pb, sum.back().result(), constants._1,
                 FMT(annotation_prefix, ".selector_sum_one"));
  }
...
public:
  ...
  ArraySelectGadget(ProtoboardT &_pb, const VariableArrayT &selector,
    ...
    for (unsigned int i = 0; i < values.size(); i++) {
      results.emplace_back(
          ArrayTernaryGadget(_pb, selector[i], values[i],
                             (i == 0) ? values[0] : results.back().result(),
                             FMT(prefix, ".results")));
    }
  }
...
public:
  ...
  OwnerValidGadget(ProtoboardT &_pb, const Constants &constants,
                   const VariableT &oldOwner, const VariableT &newOwner,
                   const std::string &prefix)
      : GadgetT(_pb, prefix),

        newOwner_equal_oldOwner(_pb, newOwner, oldOwner,
                                FMT(prefix, ".newOwner_equal_oldOwner")),
        no_oldOwner(_pb, oldOwner, constants._0, FMT(prefix, ".no_oldOwner")),
