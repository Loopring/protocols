...
public:
  ...
  Constants(ProtoboardT &pb, const std::string &prefix)
      : GadgetT(pb, prefix),
        ...
        _1000(
            make_variable(pb, ethsnarks::FieldT(1000), FMT(prefix, "._1000"))),
        _1001(
            make_variable(pb, ethsnarks::FieldT(1001), FMT(prefix, "._1001"))),
        _10000(make_variable(pb, ethsnarks::FieldT(10000),
                             FMT(prefix, "._10000"))),
        _100000(make_variable(pb, ethsnarks::FieldT(100000),
                              FMT(prefix, "._100000"))),
        emptyStorage(make_variable(pb, ethsnarks::FieldT(EMPTY_TRADE_HISTORY),
                                   FMT(prefix, ".emptyStorage"))),
        maxAmount(make_variable(pb, ethsnarks::FieldT(MAX_AMOUNT),
                                FMT(prefix, ".maxAmount"))),
        numStorageSlots(make_variable(pb, ethsnarks::FieldT(NUM_STORAGE_SLOTS),
        ...
        txTypeTransfer(
            make_variable(pb, ethsnarks::FieldT(int(TransactionType::Transfer)),
...
public:
  ...
  DualVariableGadget(ProtoboardT &pb, const size_t width,
                     const std::string &prefix)
      : libsnark::dual_variable_gadget<FieldT>(pb, width, prefix) {}

  DualVariableGadget(ProtoboardT &pb, const VariableT &value,
                     const size_t width, const std::string &prefix)
      : libsnark::dual_variable_gadget<FieldT>(pb, value, width, prefix) {
    fromPacked = true;
  }

  DualVariableGadget(ProtoboardT &pb, const VariableArrayT &bits,
                     const std::string &prefix)
...
public:
  ...
  DynamicVariableGadget(ProtoboardT &pb, const std::string &prefix)
      : GadgetT(pb, prefix) {
    add(make_variable(pb, FMT(prefix, ".initialValue")));
    allowGeneratingWitness = true;
  }

  DynamicVariableGadget(ProtoboardT &pb, const VariableT &initialValue,
                        const std::string &prefix)
      : GadgetT(pb, prefix) {
    add(initialValue);
...
public:
  ...
  UnsafeSubGadget(ProtoboardT &pb, const VariableT &_value,
                  const VariableT &_sub, const std::string &prefix)
      : GadgetT(pb, prefix), value(_value), sub(_sub),
...
public:
  ...
  UnsafeAddGadget(ProtoboardT &pb, const VariableT &_value,
                  const VariableT &_add, const std::string &prefix)
      : GadgetT(pb, prefix), value(_value), add(_add),
        sum(make_variable(pb, FMT(prefix, ".sum"))) {}
...
public:
  ...
  UnsafeMulGadget(ProtoboardT &pb, const VariableT &_valueA,
...
public:
  ...
  AddGadget(ProtoboardT &pb, const VariableT &A, const VariableT &B,
...
public:
  ...
  SubGadget(ProtoboardT &pb, const VariableT &A, const VariableT &B,
            unsigned int n, const std::string &prefix)
      : GadgetT(pb, prefix),
...
public:
  ...
  TransferGadget(ProtoboardT &pb, DynamicVariableGadget &from,
...
public:
  ...
  TernaryGadget(ProtoboardT &pb, const VariableT &_b, const VariableT &_x,
...
public:
  ...
  ArrayTernaryGadget(ProtoboardT &pb, const VariableT &_b,
    ...
    for (unsigned int i = 0; i < x.size(); i++) {
      results.emplace_back(
          TernaryGadget(pb, b, x[i], y[i], FMT(prefix, ".results")));
...
public:
  ...
  AndGadget(ProtoboardT &pb, const std::vector<VariableT> &_inputs,
            const std::string &prefix)
...
public:
  ...
  OrGadget(ProtoboardT &pb, const std::vector<VariableT> &_inputs,
           const std::string &prefix)
      : GadgetT(pb, prefix), inputs(_inputs) {
    assert(inputs.size() > 1);
    for (unsigned int i = 1; i < inputs.size(); i++) {
...
public:
  ...
  XorArrayGadget(ProtoboardT &pb, VariableArrayT _A, VariableArrayT _B,
                 const std::string &prefix)
      : GadgetT(pb, prefix),
...
public:
  ...
  EqualGadget(ProtoboardT &pb, const VariableT &A, const VariableT &B,
              const std::string &prefix)
      : GadgetT(pb, prefix),

        difference(pb, A, B, FMT(prefix, ".difference")),
        isNonZeroDifference(pb, difference.result(),
                            FMT(prefix, ".isNonZeroDifference")),
        isZeroDifference(pb, isNonZeroDifference.result(),
...
public:
  ...
  RequireEqualGadget(ProtoboardT &pb, const VariableT &_A, const VariableT &_B,
                     const std::string &prefix)
...
public:
  ...
  RequireZeroAorBGadget(ProtoboardT &pb, const VariableT &_A,
...
public:
  ...
  RequireNotZeroGadget(ProtoboardT &pb, const VariableT &_A,
                       const std::string &prefix)
      : GadgetT(pb, prefix), A(_A),
...
public:
  ...
  RequireNotEqualGadget(ProtoboardT &pb, const VariableT &_A,
                        const VariableT &_B, const std::string &prefix)
      : GadgetT(pb, prefix), A(_A), B(_B),
...
public:
  ...
  LeqGadget(ProtoboardT &pb, const VariableT &A, const VariableT &B,
...
public:
  ...
  LtFieldGadget(ProtoboardT &pb, const VariableT &A, const VariableT &B,
                const std::string &prefix)
      : GadgetT(pb, prefix),
        ...
        Ahi(pb, subArray(Abits.result(), 254 / 2, 254 / 2),
            FMT(prefix, ".Ahi")),
        Blo(pb, subArray(Bbits.result(), 0, 254 / 2), FMT(prefix, ".Blo")),
        Bhi(pb, subArray(Bbits.result(), 254 / 2, 254 / 2),
            FMT(prefix, ".Bhi")),
...
public:
  ...
  MinGadget(ProtoboardT &pb, const VariableT &A, const VariableT &B,
            const size_t n, const std::string &prefix)
      : GadgetT(pb, prefix),

        A_lt_B(pb, A, B, n, FMT(prefix, ".(A < B)")),
        minimum(pb, A_lt_B.lt(), A, B,
...
public:
  ...
  MaxGadget(ProtoboardT &pb, const VariableT &A, const VariableT &B,
            const size_t n, const std::string &prefix)
      : GadgetT(pb, prefix),

        A_lt_B(pb, A, B, n, FMT(prefix, ".(A < B)")),
        maximum(pb, A_lt_B.lt(), B, A,
...
public:
  ...
  RequireLeqGadget(ProtoboardT &pb, const VariableT &A, const VariableT &B,
                   const size_t n, const std::string &prefix)
      : GadgetT(pb, prefix),
...
public:
  ...
  RequireLtGadget(ProtoboardT &pb, const VariableT &A, const VariableT &B,
                  const size_t n, const std::string &prefix)
      : GadgetT(pb, prefix),
...
public:
  ...
  IfThenRequireGadget(ProtoboardT &pb, const VariableT &C, const VariableT &A,
                      const std::string &prefix)
      : GadgetT(pb, prefix),
...
public:
  ...
  IfThenRequireEqualGadget(ProtoboardT &pb, const VariableT &C,
...
public:
  ...
  IfThenRequireNotEqualGadget(ProtoboardT &pb, const VariableT &C,
                              const VariableT &A, const VariableT &B,
                              const std::string &prefix)
      : GadgetT(pb, prefix),
...
public:
  ...
  MulDivGadget(ProtoboardT &pb, const Constants &constants,
      ...
      : GadgetT(pb, prefix),
        ...
        denominator_notZero(pb, denominator,
        ...
        remainder_lt_denominator(pb, remainder.packed, denominator,
                                 numBitsDenominator,
...
public:
  ...
  RequireAccuracyGadget(ProtoboardT &pb, const VariableT &_value,
      ...
      : GadgetT(pb, prefix),
        ...
        value_leq_original(pb, value.packed, original, maxNumBits,
                           FMT(prefix, ".value_lt_original")),

        original_mul_accuracyN(
            make_variable(pb, FMT(prefix, ".original_mul_accuracyN"))),
        value_mul_accuracyD(
            make_variable(pb, FMT(prefix, ".value_mul_accuracyD"))),
...
public:
  ...
  FloatGadget(ProtoboardT &pb, const Constants &_constants,
    ...
    for (unsigned int i = 0; i < floatEncoding.numBitsExponent; i++) {
      baseMultipliers.emplace_back(
          make_variable(pb, FMT(prefix, ".baseMultipliers")));
...
struct SelectorGadget : public GadgetT {
  ...
  SelectorGadget(ProtoboardT &pb, const Constants &_constants,
    ...
    for (unsigned int i = 0; i < maxBits; i++) {
      ...
      sum.emplace_back(pb, (i == 0) ? constants._0 : sum.back().result(),
  ...
  void generate_r1cs_constraints() {
    ...
    requireEqual(pb, sum.back().result(), constants._1,
...
public:
  ...
  SelectGadget(ProtoboardT &pb, const VariableArrayT &selector,
    ...
    for (unsigned int i = 0; i < values.size(); i++) {
      results.emplace_back(
          TernaryGadget(pb, selector[i], values[i],
...
public:
  ...
  ArraySelectGadget(ProtoboardT &pb, const VariableArrayT &selector,
