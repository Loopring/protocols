...
class Constants : public GadgetT
{
  public:
    ...
    const VariableT txTypeSignatureVerification;
    ...
    Constants( //
      ...
      const std::string &prefix)
        : GadgetT(pb, prefix),
          ...
          txTypeSignatureVerification(make_variable(
            pb,
            ethsnarks::FieldT(int(TransactionType::SignatureVerification)),
            FMT(prefix, ".txTypeSignatureVerification"))),
    ...
    void generate_r1cs_constraints()
    {
        ...
        pb.add_r1cs_constraint(
          ConstraintT(
            txTypeSignatureVerification, FieldT::one(), ethsnarks::FieldT(int(TransactionType::SignatureVerification))),
          ".txTypeSignatureVerification");
    }
};
