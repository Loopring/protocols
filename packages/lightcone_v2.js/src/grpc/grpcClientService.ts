...
class GrpcClientService {
  ...
  public async getTokens(param: GetTokensReq): Promise<GetTokensRes> {
    ...
    return new Promise<GetTokensRes>(
      (resolve: Function, reject: Function): void => {
        this.client.getTokens(
          req,
          null,
          (err: grpcWeb.Error, res: GetTokensRes) => {
            if (err) {
              return reject(err);
            }
            resolve(res);
  ...
  public async getMarkets(param: GetMarketsReq): Promise<GetMarketsRes> {
    ...
    return new Promise<GetMarketsRes>(
      (resolve: Function, reject: Function): void => {
        this.client.getMarkets(
          req,
          null,
          (err: grpcWeb.Error, res: GetMarketsRes) => {
            if (err) {
              return reject(err);
            }
            resolve(res);
  ...
  public async getMarketFills(param: GetMarketFillsReq): Promise<GetFillsRes> {
    ...
    return new Promise<GetFillsRes>(
      (resolve: Function, reject: Function): void => {
        this.client.getMarketFills(
          req,
          null,
          (err: grpcWeb.Error, res: GetFillsRes) => {
            if (err) {
              return reject(err);
            }
            resolve(res);
  ...
  public async getUserTransactions(
    param: GetUserTransactionsReq
  ): Promise<GetUserTransactionsRes> {
    ...
    return new Promise<GetUserTransactionsRes>(
      (resolve: Function, reject: Function): void => {
        this.client.getUserTransfers(
          req,
          null,
          (err: grpcWeb.Error, res: GetUserTransactionsRes) => {
            if (err) {
              return reject(err);
            }
            resolve(res);
  ...
  public async getOrderBook(param: GetOrderBookReq): Promise<OrderBook> {
    ...
    return new Promise<OrderBook>(
      (resolve: Function, reject: Function): void => {
        this.client.getOrderBook(
          req,
          null,
          (err: grpcWeb.Error, res: OrderBook) => {
            if (err) {
              return reject(err);
            }
            resolve(res);
  ...
  public async getUserOrders(
    ...
    return new Promise<GetUserOrdersRes>(
      (resolve: Function, reject: Function): void => {
        this.client.getUserOrders(
          req,
          null,
          (err: grpcWeb.Error, res: GetUserOrdersRes) => {
            if (err) {
              return reject(err);
            }
            resolve(res);
