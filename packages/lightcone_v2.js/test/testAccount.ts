...
describe("config test", function() {
  ...
  it("account sign create account", function(done) {
    let wallet = new Account(privateKeyAccount);
    let signed = wallet.createOrUpdateAccount("Abc!12345", 10, 10);
    const expected = {
      signedTx:
  ...
  it("account sign deposit", function(done) {
    let wallet = new Account(privateKeyAccount);
    let signedTx = wallet.depositTo("LRC", "10", 10, 10);
    const expected =
  ...
  it("account sign approve", function(done) {
    let wallet = new Account(privateKeyAccount);
    let signedTx = wallet.approve("LRC", 10, 10);
    const expected =
  ...
  it("account sign withdraw", function(done) {
    let wallet = new Account(privateKeyAccount);
    let signedTx = wallet.withdrawFrom("LRC", "10", 10, 10);
    const expected =
