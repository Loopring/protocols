...
class Account {
  ...
  verifyPassword(publicKeyX, publicKeyY, password) {
    try {
      assert(this.account !== null);
      return __1.exchange.verifyPassword(
        publicKeyX,
        publicKeyY,
  ...
  createOrUpdateAccount(password, nonce, gasPrice, permission) {
    return __awaiter(this, void 0, void 0, function*() {
      try {
        ...
        const createOrUpdateAccountResposne = __1.exchange.createOrUpdateAccount(
          this.account,
          password,
          nonce,
          gasPrice,
  ...
  depositTo(symbol, amount, nonce, gasPrice) {
    return __awaiter(this, void 0, void 0, function*() {
      try {
        const rawTx = __1.exchange.deposit(
          this.account,
          symbol,
          amount,
          nonce,
  ...
  onchainWithdrawal(symbol, amount, nonce, gasPrice) {
    return __awaiter(this, void 0, void 0, function*() {
      try {
        const rawTx = __1.exchange.withdraw(
          this.account,
          symbol,
          amount,
          nonce,
