 ...
 */
function toBN(mixed) {
  return mixed instanceof bn_js_1.default
    ? mixed
    : new bn_js_1.default(toBig(mixed).toString(10), 10);
}
exports.toBN = toBN;
/**
 *
...
function formatAddress(mixed) {
  if (mixed instanceof Buffer) {
    return ethereumjs_util_1.default.toChecksumAddress(
      "0x" + mixed.toString("hex")
    );
  }
  if (typeof mixed === "string") {
    return ethereumjs_util_1.default.toChecksumAddress(
