...
const AbiFunction_1 = __importDefault(require("./AbiFunction"));
...
class Contract {
    constructor(abi) {
        ...
        this.abiFunctions = funAbi.reduce((acc, item) => {
            ...
            return Object.assign(Object.assign({}, acc), { [item.name]: new AbiFunction_1.default(item), [key]: new AbiFunction_1.default(item), [methodHash]: new AbiFunction_1.default(item) });
        });
    }
    /**
