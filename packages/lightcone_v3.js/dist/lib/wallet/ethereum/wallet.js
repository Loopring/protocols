...
const setWallet = wallet => {
    const wallets = typeof localStorage !== "undefined" && localStorage.wallet
...
const getNonce = (address) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const nonce = formatter_1.toNumber((yield utils_1.getTransactionCount(address, "pending"))["result"]) || 0;
        const localNonce = getWallet(address) && getWallet(address).nonce
