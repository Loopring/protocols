...
Constants.MAX_AMOUNT = new bn_js_1.default(2).pow(new bn_js_1.default(96)).sub(new bn_js_1.default(1));
...
Constants.scalarField = new bn_js_1.default("21888242871839275222246405745257275088548364400416034343698204186575808495617", 10);
