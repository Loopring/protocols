...
import "../iface/IAccount.sol";
import "../iface/IPaymaster.sol";

import "../iface/IAggregatedAccount.sol";
import "../iface/IEntryPoint.sol";
import "./BadStakeManager.sol";
import "../core/SenderCreator.sol";

contract BadEntryPoint is IEntryPoint, BadStakeManager {
